...
import { techPreset, healthcarePreset, startupPreset, minimalPreset } from '@spexop/theme';
      ...
      <Grid columns={12} gap={24} style={{ padding: '48px' }}>
        ...
        <GridItem span={6}>
          <Card>
            ...
            <p>Click buttons above to switch between different theme presets in real-time</p>
          </Card>
        </GridItem>
        ...
        <GridItem span={12}>
          <Card>
            ...
            <Stack gap={8}>
              <p><strong>Tech:</strong> Blue and modern tech aesthetic</p>
              <p><strong>Healthcare:</strong> Clean and trustworthy medical theme</p>
              <p><strong>Startup:</strong> Bold and energetic startup vibe</p>
              <p><strong>Minimal:</strong> Simple and elegant minimalism</p>
            </Stack>
          </Card>
        </GridItem>
      </Grid>
