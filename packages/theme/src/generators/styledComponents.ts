 ...
 * Generates styled-components theme object
 *
 ...
 * @returns Styled Components theme TypeScript string
 */
export function generateStyledComponents(config: SpexopThemeConfig): string {
  ...
  return `/**
 * ${config.meta.name} - Styled Components Theme
...
declare module 'styled-components' {
  export interface DefaultTheme {
    colors: {
      ...
      ${colors.secondaryHover ? "secondaryHover: string;" : ""}
      ${colors.secondaryActive ? "secondaryActive: string;" : ""}
      surface: string;
